<?php
		...
		if($_POST['action']=='DELETE'){
				$query="DELETE FROM tbl_customer WHERE id='".$_POST['EditID']."' ";
				mysql_query($query);
		}
  ...
  <tr>
    <td class="txt10-black"><table width="100%" border="0" cellspacing="1" cellpadding="3">
        <tr class="txt10-black">
          <td width="100%" height="30" align="left" bgcolor="#FFFFFF" class="txt10-black" ><img src="images/black_icon/16x16/notepad_2.png" width="16" height="16" hspace="5" align="absmiddle" />รายชื่อลูกค้า  
            <input type="hidden" name="action" id="action" />
            <input type="hidden" name="EditID" id="EditID" />            
            <input type="hidden" name="img" id="img" /></td>
        </tr>
        <tr>
          <td align="left" class="txt10-black"><table width="100%" border="0" cellspacing="1" cellpadding="1">
            ...
            <tr>
              ...
              <td align="center">
                <a href="main.php?work=memberdetail&currentID=<?php echo $data['id']?>"><img src="images/black_icon/16x16/zoom.png" width="16" height="16" border="0" /></a>
              </td>
              <td align="center">
              <a href="javascript:void(0)" onclick="DeleteThis('<?php echo $data['id']?>','<?php echo $data['cust_name']?>')" title="ลบ รายการนี้">
            ...
            <a href="main.php?work=customerList&page=<?php echo $i?>" >
