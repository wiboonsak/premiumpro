    ...
    <td>
      <table width="550" border="0" cellpadding="3" cellspacing="0"  class="tableborder_full">
        <tbody>
          <tr>
            <td 
          height="15" colspan="5"  valign="top" nowrap="nowrap" class="txt10-brown"><img src="images/black_icon/16x16/users.png" width="16" height="16" hspace="10" vspace="5" align="absmiddle" />รายชื่อ admin </td>
          </tr>
          ...
          <tr>
            ...
            <td width="258" bgcolor="#F7F7F7" class="txt10-black">u : <?php echo $data['username']?></td>
            <td width="13" align="center" bgcolor="#F7F7F7" class="txt10-black">
              <!--<?php if($data['adminType']==2){?>
        admin<?php } else { ?> พนักงาน <?php }?> -->
            </td>
            <td width="45" align="center" bgcolor="#F7F7F7"><?php if($data['adminType']=='2'){ ?>
