            ...
            <div class="container-fluid">
				...
				<div class="col-12">
						  <div class="card m-b-5  bg-success text-xs-center">
                            <div class="card-body">
								  <h5 class="card-title">เพิ่มข้อมูลสินค้า</h5>
							  <div class="form-group row">
								...
								<div class="col-md-5">
									...
									<select class="form-control form-control-sm">
										<option value="x">--เลือกหมวดสินค้า--</option>
										<option value="">อุปกรณ์นั่งร้าน</option>
										<option value="">แบบก่อสร้าง</option>
										<option value="">แผ่นเหล็ก</option>
										<option value="">เครื่องมือก่อสร้าง</option>
									</select>
								</div> 
							  </div> 
								 <div class="form-group row">
						...
						<div style="clear: both">&nbsp;</div>	
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover ">
                                            ...
                                            <tr>
                                                <th width="4%">#</th>
                                                <th width="52%">ชื่อสินค้า</th>
                                                <th width="19%">หมวดสินค้า</th>
                                                <th width="10%">ใช้งาน</th>
                                                <th width="9%" align="center">แก้ไข </th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="m-0 font-weight-normal">ขาตั้ง 2.20 ม.</h5>
                                                    
                                                </td>
                                                <td><span class="m-0 font-weight-normal">อุปกรณ์นั่งร้าน</span></td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="m-0 font-weight-normal">ขาตั้ง 1.70 ม.</h5>
                                                </td>
                                                <td><span class="m-0 font-weight-normal">อุปกรณ์นั่งร้าน</span></td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="m-0 font-weight-normal">ขาตั้ง 1.20 ม.</h5>
                                                </td>
                                                <td><span class="m-0 font-weight-normal">อุปกรณ์นั่งร้าน</span></td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="m-0 font-weight-normal">ขาตั้ง 0.90 ม.</h5>
                                                </td>
                                                <td><span class="m-0 font-weight-normal">อุปกรณ์นั่งร้าน</span></td>
