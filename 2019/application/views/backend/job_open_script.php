<script>
	function comfirmDelete(dataID,table){  
					   ...
					   if(data=='1'){
						     swal({
								...
								confirmButtonClass: 'btn btn-confirm mt-2'   
                                                        ...
                                                        setTimeout(function(){ window.location.href = "<?php echo base_url('Control/job_opening')?>"; }, 2000);
     ...
     function upload(i){
					...
					$('#modal-upload'+i).modal({backdrop: 'static', keyboard: false}) 
					$("#modal-upload"+i).modal();
		}
